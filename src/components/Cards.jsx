...
function Cards() {
  ...
  return (
    <section className="cards-section min-h-screen md:min-h-[120vh] bg-black flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 px-6 md:px-10 py-20 md:py-0">
      ...
      <div className="card w-full max-w-[280px] md:w-72 h-80 md:h-96 group perspective-1000">
        <div className="relative w-full h-full transition-transform duration-700 transform-style-3d group-hover:rotate-y-180">
          ...
          text-xl md:text-2xl font-semibold text-white backface-hidden">
            HX Installations
          </div>
          ...
          backface-hidden rotate-y-180">
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
              Installations
            </h3>
            <p className="text-xs md:text-sm text-center text-gray-300 leading-relaxed">
      ...
      <div className="card w-full max-w-[280px] md:w-72 h-80 md:h-96 group perspective-1000">
        <div className="relative w-full h-full transition-transform duration-700 transform-style-3d group-hover:rotate-y-180">
          ...
          flex flex-col items-center justify-center p-6 text-white 
          backface-hidden rotate-y-180">
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
              Studio
            </h3>
            <p className="text-xs md:text-sm text-center text-gray-300 leading-relaxed">
      ...
      <div className="card w-full max-w-[280px] md:w-72 h-80 md:h-96 group perspective-1000">
        <div className="relative w-full h-full transition-transform duration-700 transform-style-3d group-hover:rotate-y-180">
          ...
          flex flex-col items-center justify-center p-6 text-white 
          backface-hidden rotate-y-180">
            <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
              Lab
            </h3>
            <p className="text-xs md:text-sm text-center text-gray-300 leading-relaxed">
